...
(function () {
  ...
  var HIDDEN_KEY = 'inspiration-library:hidden-ids';
  var app = document.getElementById('app');
  var UI = window.UI;
  var icon = UI.icon;

  // ---- tombstones (see docs/adr/0001-tombstone-deletion.md) ----------
  ...
  function renderGrid(filters) {
    ...
    root.appendChild(el('header', { class: 'library-header' }, [
      el('div', { class: 'library-title-row' }, [
        el('h1', { class: 'library-title', text: 'Inspiration Library' }),
  ...
  function renderDetail(id) {
    ...
    // 6. everything past the header is tabbed (ticket 08): the design
  ...
  // ---- design system panels (ticket 05) ---------------------------------
  ...
  // — an omitted section renders as nothing, never an empty panel (see the
  // ticket's "Rules").
  ...
  // Copy (ticket 06: .scratch/design-system-extraction/issues/06-download-
  // design-md.md). Verified against a real file:// page: a blob URL through
  ...
  // docs/adr/0002-app-writes-its-own-data.md and docs/adr/0001-tombstone-deletion.md.
