...
// docs/adr/0002-app-writes-its-own-data.md, untested by unit tests, same
// convention as the DOM code in render.js. Depends on curation.js.
(function () {
  'use strict';

  var DB_NAME = 'inspiration-library';
  ...
  // to the folder picker. See docs/adr/0007-local-helper-connects-any-ai.md.
  ...
  function viaHelper(endpoint, body) {
    ...
    return fetch('/api/files/' + endpoint, {
      ...
      function () {
        throw new Error('Lost contact with Inspiration Library. Start it again, then retry.');
      }
    );
  }
  ...
  function pickProjectDirHandle() {
    var options = { id: 'inspiration-library-project', mode: 'readwrite' };
    ...
    return dirHandle
      ...
      .catch(function () {
        return forgetProjectDir().then(function () {
          throw new Error(
            'Could not find inbox.md in the selected folder. Pick the Inspiration Library project folder and try again.'
          );
        });
      })
      .then(function (inboxHandle) {
        return dirHandle
          ...
          .catch(function () {
            return forgetProjectDir().then(function () {
              throw new Error(
                'Could not find data/library.js in the selected folder. Pick the Inspiration Library project folder and try again.'
              );
            });
          })
