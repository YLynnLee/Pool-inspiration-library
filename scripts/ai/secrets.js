...
function userConfigDir(platform, env) {
  ...
  return path.join(env.XDG_CONFIG_HOME || path.join(os.homedir(), '.config'), 'pool');
}
...
// 'file') — the tests use 'file' with a temp dir. POOL_SECRETS does
...
function createStore(options) {
  ...
  var wanted = options.backend || env.POOL_SECRETS || '';
