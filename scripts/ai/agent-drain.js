...
// and runs the scripts itself. See docs/adr/0007-local-helper-connects-any-ai.md.
...
function buildPrompt(url) {
  ...
  return prompt.replace('URL (optional):', 'URL (optional): ' + (url || '(none — drain the whole inbox)')) +
    '\n\nYou were started from the Inspiration Library app, not a terminal: nobody can answer questions ' +
