    ...
    methods: [
      {
        ...
        preset: 'gemini',
        app: 'Gemini CLI',
        needs: 'Any Google account (there’s a free daily allowance).',
        docs: 'https://github.com/google-gemini/gemini-cli',
        install: { unix: 'npm install -g @google/gemini-cli', win: 'npm install -g @google/gemini-cli' },
        login: { command: 'gemini', steps: 'Gemini CLI opens. Choose “Sign in with Google” and finish in your browser, then type /quit and close the window.' },
      },
